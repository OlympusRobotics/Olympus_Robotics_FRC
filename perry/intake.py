...
class Intake(commands2.Subsystem):
    def __init__(self):
        ...
        # motor init
        self.intakeDrive = rev.CANSparkMax(100, rev.CANSparkMax.MotorType.kBrushless)
        self.intakeRotation = rev.CANSparkMax(101, rev.CANSparkMax.MotorType.kBrushless)
        ...
        self.intakeDownSetpoint = 10 # rotations for the bottom position of the intake
