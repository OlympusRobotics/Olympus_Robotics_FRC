...
//these are all of the constants for the drivetrain, this is mostly generated by Phoenix Tuner X but does require some adjustments such as feedback adn feedforward values and max speeds etc.
...
// NOTE: Changes to swerve tuning, motor IDs, or encoder offsets here
// must also be reflected in Theseus/README.md (Swerve Drivetrain section).
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(.15698).withKI(0).withKD(0)
        .withKS(.22672).withKV(0.11671).withKA(0.0028144);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.107421875);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.210693359375);
    ...
    public static Drivetrain createDrivetrain() {
        return new Drivetrain(
            ...
            VecBuilder.fill(4, 4, 0.01),
            VecBuilder.fill(100000, 100000, 9999999999.0),
